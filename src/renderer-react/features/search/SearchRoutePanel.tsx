...
import { OnlineMusicPreviewList, OnlinePager, OnlineSongListPreviewList } from '../online/OnlinePreviewList'
...
export const SearchRoutePanel = observer(() => {
  ...
  const resultState = search.searchType === 'music'
    ? search.activeMusicList
    : search.activeSongList
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' }}>
      ...
      {/* Errors */}
      {search.searchError
        ? <Alert showIcon type="error" message={search.searchError} closable style={{ margin: '0 15px 8px', flex: 'none' }} />
        : null}
      {list.actionError
