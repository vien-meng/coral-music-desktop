...
const getClassName = (...names: Array<string | undefined | false>) => names.filter(Boolean).join(' ')
...
export const PlainList = <Item,>({
  ...
  const emptyContent = empty ?? <Empty image={Empty.PRESENTED_IMAGE_SIMPLE} description="暂无数据" />
