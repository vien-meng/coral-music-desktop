...
const { createCipheriv, createDecipheriv, publicEncrypt, randomBytes, createHash, constants } =
  globalThis.require('node:crypto');
...
export const eapiDecrypt = (cipherBuffer) =>
  aesDecrypt(cipherBuffer, 'aes-128-ecb', eapiKey, '').toString();
