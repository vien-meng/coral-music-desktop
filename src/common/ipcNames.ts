const modules = {
  ...
  winMain: {
    ...
    audio_output_list_devices: 'audio_output_list_devices',
    audio_output_probe_exclusive: 'audio_output_probe_exclusive',
    audio_output_start: 'audio_output_start',
    audio_output_pause: 'audio_output_pause',
    audio_output_resume: 'audio_output_resume',
    audio_output_seek: 'audio_output_seek',
    audio_output_stop: 'audio_output_stop',
