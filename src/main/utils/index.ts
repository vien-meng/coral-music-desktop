...
export const initSetting = async () => {
  ...
  let setting = electronStore_config.get("setting") as Partial<LX.AppSetting> | null | undefined;
...
export const initHotKey = async () => {
  ...
  let localConfig = electronStore_hotKey.get("local") as LX.HotKeyConfig | null | undefined;
  let globalConfig = electronStore_hotKey.get("global") as LX.HotKeyConfig | null | undefined;
...
const saveHotKeyConfig = throttle<[LX.HotKeyConfigAll]>(
...
export const getTheme = () => {
  ...
  if (!theme) {
    ...
    if (theme) {
      ...
      themeId =
        global.lx.appSetting["theme.id"] == "auto" && shouldUseDarkColors
          ? "black"
          : "green";
...
export const getProxy = () => {
  if (
    ...
    global.lx.appSetting["network.proxy.host"]
  ) {
    return {
