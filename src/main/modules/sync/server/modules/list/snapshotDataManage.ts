...
interface SnapshotInfo {
  ...
  time: number;
  list: string[];
  clients: Record<string, Coral.Sync.List.ListInfo>;
}
export class SnapshotDataManage {
  ...
  isIncluedsDevice = (key: string) => this.clientSnapshotKeys.includes(key);
  ...
  getSnapshotInfo = async (): Promise<SnapshotInfo> => this.snapshotInfo;
